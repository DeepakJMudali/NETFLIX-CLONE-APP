...
// 				}
// 				<img
// 					src={trendingContent?.primaryImage}
// 					alt='Hero img'
...
// 							{trendingContent?.primaryTitle}
// 						</h1>
// 						<p className='mt-2 text-lg'>
// 							{trendingContent?.releaseDate?.split("-")[0]}{" "}
// 							| {trendingContent?.isAdult ? "18+" : "PG-13"}
// 						</p>
			...
			<div className='relative h-screen text-white'>
				...
				<div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
					...
					<div className='max-w-2xl'>
						...
						<p className='mt-2 text-lg'>
							{trendingContent?.releaseDate} | {trendingContent?.isAdult ? "18+" : "PG-13"}
						</p>
					</div>
